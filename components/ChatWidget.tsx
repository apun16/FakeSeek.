...
export default function ChatWidget() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 1,
      text: "Hi! I'm your digital safety assistant. I can help you learn about deepfakes, phishing protection, and online safety. How can I assist you today?",
      isUser: false,
      timestamp: new Date()
    }
  ])
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 left-6 bg-blue-500 hover:bg-blue-600 text-white p-4 rounded-full shadow-lg transition-all duration-300 hover:scale-110 z-50"
      >
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-6 left-6 w-96 h-[500px] bg-white rounded-lg shadow-2xl z-50 flex flex-col">
          {/* Chat Header */}
          <div className="bg-blue-500 text-white p-4 rounded-t-lg flex justify-between items-center">
            <div>
              <h3 className="font-semibold">Digital Safety Assistant</h3>
