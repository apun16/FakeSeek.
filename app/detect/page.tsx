                ...
                <div className="flex flex-col items-center justify-center space-y-6">
                  {!scanInProgress && !scanComplete ? (
                    ...
                    <div className="flex flex-col items-center space-y-4">
                      <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-orange"></div>
                      <p className="text-lg font-author text-gray-700 dark:text-white/80">
                        Scan in Progress...
                      </p>
                    </div>
                  ) : (
                    ...
                    <div className="w-full max-w-2xl">
                      <div className={`p-6 rounded-lg border-2 ${
                        ...
                        <div className="bg-white/50 dark:bg-black/20 rounded-lg p-4 mt-4">
                          <h4 className="font-oswald font-bold text-gray-800 dark:text-white mb-2">
                          ...
                          <div className="grid grid-cols-2 gap-4 text-sm font-author">
                            <div>
                              ...
                              <span className="ml-2 font-bold text-gray-800 dark:text-white">{scanResults.total_results}</span>
                            </div>
                            <div>
                              <span className="text-gray-600 dark:text-gray-300">Deepfake Related:</span>
                              <span className="ml-2 font-bold text-gray-800 dark:text-white">{scanResults.deepfake_related_count}</span>
                            </div>
                          </div>
                        </div>
